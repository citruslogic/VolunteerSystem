...
namespace VolunteerSystem.Migrations
{
    ...
    partial class ComplexDataModel
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("VolunteerSystem.Models.OpportunityVolunteer", b =>
                {
                    b.Property<int>("OpportunityID");

                    b.Property<int>("VolunteerID");

                    b.HasKey("OpportunityID", "VolunteerID");

                    b.HasIndex("VolunteerID");

                    b.ToTable("OpportunityVolunteer");
                });
            ...
            modelBuilder.Entity("VolunteerSystem.Models.OpportunityVolunteer", b =>
                {
                    b.HasOne("VolunteerSystem.Models.Opportunity", "Opportunity")
                        .WithMany()
                        .HasForeignKey("OpportunityID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("VolunteerSystem.Models.Volunteer", "Volunteer")
                        .WithMany()
                        .HasForeignKey("VolunteerID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
